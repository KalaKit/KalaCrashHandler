#!/bin/bash
# This script builds KalaCrashHandler from source using g++ and CMake with Unix Makefiles in Release mode on Linux.

# Set the root folder as the location of this script
KALACRASH_ROOT="$(dirname "$(readlink -f "$0")")"
BUILD_DIR="$KALACRASH_ROOT/build-release"
INSTALL_DIR="$KALACRASH_ROOT/install-release"
...
# Configure KalaCrashHandler with CMake using Unix Makefiles
